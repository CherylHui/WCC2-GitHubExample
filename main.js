...
function init() {
  ...
  // const noisyTexture = textureLoader.load( 'textures/lava/lavatile.jpg' );
  const noisyTexture = textureLoader.load( 'textures/skin/Abstract_Organic_01.jpg' );
  // const noisyTexture = textureLoader.load( 'textures/skin/Abstract_Organic_02.jpg' );
  // const noisyTexture = textureLoader.load( 'textures/skin/Abstract_Organic_height.jpg' );
  const baseColorTexture = textureLoader.load( 'textures/skin/Abstract_Organic_basecolor.jpg' );
